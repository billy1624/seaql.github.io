...
> If you don't have `sea-orm-cli` installed yet, please refer to [Using sea-orm-cli](03-generate-entity/01-sea-orm-cli.md) page to learn more about the Sea ORM CLI.
